...
Projekcja dwuwymiarowa skutkuje utratą części informacji przestrzennej, przez co różne obiekty lub ich różne orientacje mogą prowadzić do podobnych obrazów. Dodatkowym utrudnieniem może być częściowe zasłonienie obiektów. Istnieją modele estymujące głębię, np. YOLO26*-depth \ref{ssec:warianty_zadanie}, opisany w sekcji \ref{ssec:warianty_zadanie}, jednak otrzymane z nich wartości nie stanowią pomiaru odległości, a ich dokładność zależy od wielu czynników. Z tego względu uzupełnienie obrazu o informację dotyczącą odległości punktów od kamery wydaje się przydatne podczas procesu rozpoznania brył trójwymiarowych.
