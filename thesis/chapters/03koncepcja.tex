...
Transmisja obrazu i~detekcja powinny być kontynuowane niezależnie od pozostałych działań systemu, aby mógł pozostać gotowym do przyjęcia kolejnego żądania od~\nobreakdash{użytkownika}.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\textwidth]{./graf/bryly.jpg}
