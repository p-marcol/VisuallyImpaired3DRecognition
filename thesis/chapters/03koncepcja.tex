...
\note{
    Funkcjonalne: akwizycja obrazu, przesyłanie klatek, detekcja obiektu, informacja zwrotna.
    Niefunkcjonalne: możliwie niskie opóźnienie, prostota użycia, mobilność, powtarzalność badań.
}
