...
Zadanie analizy rozpoczyna się od pobrania aktualnie dostępnego wyniku detekcji i wyodrębnienia z klatki wycinka odpowiadającego ramce detekcji. Dalsze przetwarzanie odbywa się w module \texttt{SliceAnalyzer}, gdzie po odebraniu wycinka i danych z modelu detekcji, przygotowywany jest tekst do przekazania użytkownikowi.
