...
\section{Proces pozyskiwania i oznaczania danych}
\note{
...
\note{
    Train/val/test. Tu trzeba bardzo jasno wyjaśnić, jak dzielę dane, żeby recenzent nie zarzucił przecieku danych.
}

\section{Warianty danych wejściowych}
\note{
    Kolor, grayscale, ewentualne filtry/normalizacja. To będzie dobre miejsce na porównanie „kolor vs grayscale”.
}

\section{Konfiguracja treningu modeli}
\note{
