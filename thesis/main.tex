...
\newcommand{\Supervisor}{Dr hab. inż. Michał Maćkowski, prof. PŚ}     % dane promotora (bez $\langle$ i $\rangle$)
...
% TODO
\input{chapters/01wstep.tex}  % Wstęp

% TODO
\input{chapters/02analiza.tex} % Analiza problemu i przegląd literatury

% TODO
\input{chapters/03koncepcja.tex} % Koncepcja zaproponowanego systemu

% TODO
\input{chapters/04implementacja.tex} % Implementacja systemu

% TODO
\input{chapters/05zbior.tex} % Zbiór danych i metodyka badań

% TODO
\input{chapters/06wyniki.tex} % Wyniki badań i ich analiza

% TODO
\input{chapters/07podsumowanie.tex} % Podsumowanie i wnioski końcowe
...
\begin{appendices}
    ...
    % TODO
    \input{chapters/09skroty.tex} % Spis skrótów i symboli
